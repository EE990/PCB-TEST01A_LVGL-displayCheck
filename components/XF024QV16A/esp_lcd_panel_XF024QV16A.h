...
extern esp_err_t esp_lcd_new_panel_xf024qv16a(const esp_lcd_panel_io_handle_t *io, const esp_lcd_panel_dev_config_t *panel_dev_config,esp_lcd_panel_handle_t *ret_panel,size_t interface_buffer_size);
