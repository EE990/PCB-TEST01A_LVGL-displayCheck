#ifndef __ESP_LCD_PANEL_XF024QV04B_H__
#define __ESP_LCD_PANEL_XF024QV04B_H__
...
//列舉xf024qv04b的介面
typedef enum{
    XF024QV04B_INTERFACE_SPI = 0,
    XF024QV04B_INTERFACE_I80 = 1,
}xf024qv04b_interface_t;
...
extern esp_err_t esp_lcd_new_panel_xf024qv04b(const esp_lcd_panel_io_handle_t *io, const esp_lcd_panel_dev_config_t *panel_dev_config,esp_lcd_panel_handle_t *ret_panel,int interfasce,size_t interfasce_buffer_size);
